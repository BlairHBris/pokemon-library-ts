...
})({"4ks6d":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "480c027bf42f845d";
...
const { addPokemon  } = require('./index');
function addAbilities(pokemon1) {
    const li = document.createElement("li");
    li.innerHTML = `
    <span class="ability-name">${pokemon1.name}</span>
    <br>
    <span class="ability-short-description">${pokemon1.effect_entries[1].short_effect}</span>
    `;
    ul.append(li);
}
...
},{"./index":"6gRYP"}],"6gRYP":[function(require,module,exports) {
...
},{}]},["4ks6d","bZL5y"], "bZL5y", "parcelRequire80db")

//# sourceMappingURL=pokemon.f42f845d.js.map
